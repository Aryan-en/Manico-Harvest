      ...
      <div className="relative mx-auto w-full max-w-[1280px] px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1 min-w-0 text-center lg:text-left order-2 lg:order-1">
            ...
            <div
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-[0.18em] mb-6"
              style={{
            ...
            <h1
              className="font-bold tracking-tight mb-5 text-primary"
            ...
            <p
              className="text-lg mb-8 max-w-md mx-auto lg:mx-0 text-secondary"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-10">
              ...
              <a
                href="/about"
                className="flex items-center justify-center gap-2 w-full sm:w-auto font-semibold rounded-xl transition-all active:scale-[0.98]"
                style={{
                  padding: "13px 28px",
                  fontSize: "15px",
            ...
            <div className="relative">
              ...
              >
                <Image
                  ...
                  alt="Moringa Sattu — 500g plant-based protein"
                  fill
              ...
              <div
                className="absolute -bottom-4 -left-2 sm:-left-6 flex items-center gap-3 rounded-2xl p-3 bg-surface"
                style={{
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-secondary mt-0.5">₹349 · 100g</p>
                </div>
              </div>

              {/* Floating badge — Millet Chilla */}
              <div
                className="absolute -top-4 -right-2 sm:-right-6 flex items-center gap-3 rounded-2xl p-3 bg-surface"
                style={{
                  boxShadow: "var(--shadow-xl)",
                  border: "1px solid var(--color-border)",
                  maxWidth: "190px",
