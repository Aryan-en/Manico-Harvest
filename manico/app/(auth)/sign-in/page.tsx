    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl p-8 bg-surface" style={{ boxShadow: 'var(--shadow-xl)', border: '1px solid var(--color-border)' }}>
        ...
        <p className="text-sm mb-6" style={{ color: 'var(--color-text-secondary)' }}>
          Sign in to your Manico Harvest account
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
          ...
          <div className="space-y-1.5">
            <label htmlFor="si-email" className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>
              Email
            </label>
            <input
              id="si-email"
            ...
            />
            {errors.email && (
              <p id="si-email-error" role="alert" className="text-xs" style={{ color: 'var(--color-error)' }}>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <label htmlFor="si-password" className="text-sm font-medium" style={{ color: 'var(--color-text-primary)' }}>
                Password
              </label>
              <Link
            ...
            {errors.password && (
              <p id="si-password-error" role="alert" className="text-xs" style={{ color: 'var(--color-error)' }}>
        ...
        <p className="mt-5 text-center text-sm" style={{ color: 'var(--color-text-secondary)' }}>
          ...
          <Link href="/sign-up" className="font-semibold hover:underline" style={{ color: 'var(--color-brand-accent)' }}>
            Sign Up
          </Link>
        </p>
      </div>
